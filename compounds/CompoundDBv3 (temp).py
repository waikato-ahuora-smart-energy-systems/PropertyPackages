...
class CompoundRegistry:
    ...
    def register_package(self, package: PropertyPackage):
        """
    ...
    def get_package(self, package_name: str) -> PropertyPackage:
        """
    ...
    def register_compound(self, compound: str, source: str, data: dict):
        """
    ...
    def get_compound(self, compound_name: str) -> Compound:
        """
    ...
    def bind(self, compound_name: str, package_name: str):
        """
    ...
    def dynamic_bind(self, package_name: str):
        """
    ...
    def get_supported_packages(self, compounds: Set[str], strict=True) -> Set[str]:
        """
    ...
    def get_supported_compounds(self, packages: Set[str], strict=True) -> Set[str]:
        """
    ...
    def get_compound_names(self) -> list:
        """
