...
#     m.fs.compressor.inlet.pressure.fix(200000) # Pa
#     m.fs.compressor.inlet.temperature.fix(300) # K
...
#     m.fs.compressor.inlet.flow_mol[0].fix(1) # Mol/s

#     m.fs.compressor.outlet.pressure.fix(400000*units.Pa)
