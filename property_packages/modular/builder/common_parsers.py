    ...
    def serialise(compounds: List[Compound], valid_states: List[States]) -> Dict[str, Any]:
        ...
        if (min_critical_temperature > 500):
            return {
                ...
                "temperature": (min_melting_point-50, 300, 500, pyunits.K),
            ...
            return {
                "flow_mol": (0, 100, 1000, pyunits.mol / pyunits.s),
                "temperature": (min_melting_point-50, 200, 400, pyunits.K),
                "pressure": (5e4, 1e5, 1e6, pyunits.Pa),
                "enth_mol": (-300000, 30000, 150000, pyunits.J/pyunits.mol),
            }
            ...
            return {
                "flow_mol": (0, 100, 1000, pyunits.mol / pyunits.s),
                "temperature": (min_melting_point-50, 150, 500, pyunits.K),
                "pressure": (5e4, 1e5, 1e6, pyunits.Pa),
                "enth_mol": (-300000, 30000, 150000, pyunits.J/pyunits.mol),
            }
        else:
            return {
                "flow_mol": (0, 100, 1000, pyunits.mol / pyunits.s),
                "temperature": (min_melting_point-50, 150, 350, pyunits.K),
                "pressure": (5e4, 1e5, 1e6, pyunits.Pa),
                "enth_mol": (-300000, 30000, 150000, pyunits.J/pyunits.mol),
            }
