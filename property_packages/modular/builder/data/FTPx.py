...
from idaes.models.properties.modular_properties.state_definitions.electrolyte_states import define_electrolyte_state, calculate_electrolyte_scaling
...
def state_initialization(b):
    ...
    for pp in _pe_pairs:
        ...
        if (
            ...
            print(identify_VL_component_list(b, pp))
